...
function ClientList() {
    ...
    mimmsRouter.route('/CarePlan/clinicid/').post((req, res) => {

        console.log(req.body.clinic_id);
        var identifier = req.body.clinic_id;
...
function PatientOiid() {
    ...
    mimmsRouter.route('/Patient/oiid/').post((req, res) => {

        var oiid = req.body.oiid;
        let panorama_user = req.headers.panorama_user;
...
function PatientClientid() {
    ...
    mimmsRouter.route('/Patient/clientid/').post((req, res) => {
